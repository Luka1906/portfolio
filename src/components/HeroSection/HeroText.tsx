...
export default function HeroText() {
  return (
    <section className="w-full max-w-150 flex flex-col gap-9">
      <div className="flex flex-col gap-4.5">
        <p className="text-lg uppercase text-accent font-medium">Hi, I'm</p>
        <div className="">
          <p className="text-[80px] font-extrabold font-accent text-white h-24">
            Luka Matovic<span className="text-accent text-[70px]">.</span>
          </p>
          <p className="font-medium text-[52px] text-secondary-text">
            Software Developer
          </p>
        </div>
      </div>
